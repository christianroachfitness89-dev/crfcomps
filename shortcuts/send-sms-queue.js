 ...
 *
 * Runs on macOS, fetches a queue from CRF Comps, sends each message via the
 * Messages app (iMessage or SMS via SMS forwarding), then reports back.
 *
 * Usage:
 *   node send-sms-queue.js
 *   (then paste the queue code when prompted)
 *
 * Or double-click send-sms-queue.command in Finder.
 */
